				...
				#for match3 in ops.getcm(alpha3):
					...
					#for match4 in ops.getcm(alpha4):
						for match5 in alpha5.possib:
							...
							allFirsts.append([match1, match2, match3, match4, match5])
							assert len(allFirsts[0]) == 5
							#print '\n\n%r\n\n' % allFirsts
...
if rank == 0:
	for i in range(1,size):
		comm.send(proc=i, allFirsts[i])

if rank != 0:
	allFirst = comm.recv(root=0)

processa allFirst
se ainda ha processos:
	pede novo processo
	processa
